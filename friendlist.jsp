 ...
 <head>
  <title>AngularJS Datatable Example</title>
   ...
   <spring:url value="/resources/js/libs/" var="jquery" ></spring:url>
     ...
     <!-- CUSTOM -->
     <script src='<c:url value="/resources/js/frdatatableController.js" />'></script>
 ...
 <body>
   <%@ include file="/WEB-INF/views/template/nav.jsp"%> 
    ...
    <table datatable="" class="row-border hover">
      ...
      <tbody>
       <c:forEach items="${frrequests}" var="freq">
       <tr>
         <td align="center">
         <img src="<c:url value="/resources/images/profileimg/${freq.userid}.jpg"/>"
          alt="profile image" class="img-circle"  width="20%"/></td>
         <td align="center">${freq.username}</td>
         <td align="center"><a href="<c:url value="/friendlist/${freq.userid}"/>" class="btn btn-primary">Invite</a></td>
       </tr>
       </c:forEach>
      </tbody>
    </table>
